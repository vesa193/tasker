...
<head>
  ...
  <script src="{{ asset('js/script.js') }}" deffer></script>
</head>
<body>
    ...
    <nav class="flex items-center justify-between p-[1rem] border-b-2 border-gray-50">
        ...
        <div class="username">
            ...
            <ul class="username-actions absolute bg-white border border-gray-200 rounded-[3px] w-full bottom-[-65px] left-0 flex flex-col gap-2 shadow-md z-10">
